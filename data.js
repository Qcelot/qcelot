...
export const games = {
  arcade: [
    ...
    { name: 'Grinch Simulator v2', api: 'GRINCH_SIMULATOR_V2', icon: 'player_head_present', count: 6 },
    { name: 'Halloween Simulator', api: 'HALLOWEEN_SIMULATOR', icon: 'player_head_jack_o_lantern', count: 6 },
    ...
    { name: 'Scuba Simulator', api: 'SCUBA_SIMULATOR', icon: 'player_head_pufferfish', count: 6 },
